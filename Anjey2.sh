...
echo -e "Expire \n"
read expire
if echo "$expire" | grep "[0-9]+{4}+{2}-[0-9]+{2}" /dev/null ;then
echo "NO"
UG
fi
echo -e " Comment \n"
...
echo -e "Select user \n"
read z 
echo -e "Are you sure you wamt to delete user ?"
echo -e "1 -> YES"
echo -e "2 -> NO"
read x
case $x in
...
USER()
{
echo -e "$GREEN 1.Great $END 2.Modofication $RED 3.Delete $END 4.Back $END\n"
read u
case $u in
1)
UG
...
GG()
{
echo -e "1.Custom    2.Default   3.Back"
read gg
case gg in
1)
...
echo -e "Select group \n"
read z 
echo -e "Are you sire you want wo delete the group ?"
echo -e "1 -> YES"
echo -e "2 -> NO"
read x
case $x in
...
GROUP()
{
echo -e " $GREEN 1.Great $END 2.Modification $RED 3.Delete $END 4.Back\n"
read g
case $g in
1)
GG
...
SHOW()
{
echo -e "$GREEN 1.USERS $END 2.Groups $END\n"
read s
...
echo -e " $GREEN      1.USERS---------2.GROUPS $END\n"
